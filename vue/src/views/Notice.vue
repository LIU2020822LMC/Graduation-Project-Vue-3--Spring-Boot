...
<div>
  ...
  <el-dialog title="公告信息" v-model="data.formVisible"  width="500" destroy-on-close="true">
    <el-form ref="formRef" :model="data.form" :rules="data.rules" label-width="100px" style="padding: 20px 70px 20px 0">
      ...
      <el-form-item prop="content" label="公告内容" >
        <el-input type="textarea" :rows="8" v-model="data.form.content" autocomplete="off" placeholder="请输入公告内容"/>
      </el-form-item>
    </el-form>
    <template #footer>
